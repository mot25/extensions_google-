...
// popup wrapper
// button actions
document.querySelectorAll('.buttonActions').forEach(function (button) { return button.innerHTML = '<div><span>' + button.textContent.trim().split('').join('</span><span>') + '</span></div>'; });
// button actions
...
/******/ })()
;
//# sourceMappingURL=popupVisual.js.map