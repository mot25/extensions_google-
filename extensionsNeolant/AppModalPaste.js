  ...
  \************************************************************/
    ...
    var AppModalPaste = function () {
      ...
      var pasteViewers = function (_a) {
        ...
        var isApplyReWriteIconWithEdit = configPasteEntities.find(function (_) {
          return (
            _.id ===
        ...
        entitiesFromPaste.forEach(function (entity) {
          ...
          viewerForPaste.forEach(function (viewer) {
            ...
            var settingForPost = isApplySettingsCustom
              ? __assign(__assign({}, viewer.Settings), initialCustomSettings)
              : viewer.Settings;
            var IconForPaste =
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    ...
                    case 12:
                      ...
                      return [
                        2 /*return*/,
                        __assign(__assign({}, dataPost), { Id: response.Id })
                      ];
                  }
                });
              });
