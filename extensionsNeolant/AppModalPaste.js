...
*/
  ...
  \************************************************************/
    ...
    const AppModalPaste = function (props) {
      let _a;
      const refModalWrapper = (0, react__WEBPACK_IMPORTED_MODULE_7__.useRef)(
        null
      );
      ...
      const pasteViewers = function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            ...
            isApplyReWriteIconWithEdit = configPasteEntities.find(function (_) {
              return (
                _.id ===
      ...
      (0, react__WEBPACK_IMPORTED_MODULE_7__.useEffect)(function () {
        ...
        chrome.storage.onChanged.addListener(function (changes, namespace) {
          for (let _i = 0, _a = Object.entries(changes); _i < _a.length; _i++) {
            const _b = _a[_i],
              key = _b[0],
              _c = _b[1],
