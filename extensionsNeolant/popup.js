...
var tbodyStorage = document.querySelector('.tbodyStorage');
var isSortViewer = document.getElementById('sortIsCheck');
var buttonPasteJS = document.getElementById('button');
...
buttonPasteJS.addEventListener('click', function () {
    console.log(1231);
