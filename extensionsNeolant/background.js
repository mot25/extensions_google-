    ...
    EntitiesService.getEntities = function (baseUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(baseUrl + '/api/structure/entities').then(function (_) { return _.json(); })];
                    case 1:
                        response = _a.sent();
                        ...
                        case 1:
                            ...
                            try {
                                ...
                                chrome.tabs.sendMessage(sender.tab.id, {
                                    ...
                                    payload: (0,_shared_utils_utils__WEBPACK_IMPORTED_MODULE_1__.entitiesForPasteInsert)(response, idEntities)
                                });
                            }
                            catch (error) {
